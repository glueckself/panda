...
#define PANDA_TLB_HELPER_X(cbname, prefix, endian, op)   \
    PANDA_TLB_HELPER(cbname, endian, op, ub)            \
    PANDA_TLB_HELPER(cbname, endian, op, uw)            \
    PANDA_TLB_HELPER(cbname, endian, op, ul)            \
    PANDA_TLB_HELPER_Q(cbname, prefix, endian, op)

PANDA_TLB_HELPER_X(read, load, le, ld)
PANDA_TLB_HELPER_X(read, load, be, ld)
PANDA_TLB_HELPER_X(write, store, le, st)
PANDA_TLB_HELPER_X(write, store, be, st)

#undef PANDA_TLB_HELPER_ENTRY
#undef PANDA_TLB_HELPER_RETVAL_read
#undef PANDA_TLB_HELPER_EXIT_read
#undef PANDA_TLB_HELPER_RETVAL_write
#undef PANDA_TLB_HELPER_EXIT_write
